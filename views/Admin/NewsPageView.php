...
class AdminNewsPageView extends AdminLayoutView
{
...
?>
        <div class="container">
            <div class="Handler">
                ...
                <div>
                    <a href="/Project/Admin/news/Add/">Add News</a>
                </div>
            </div>
